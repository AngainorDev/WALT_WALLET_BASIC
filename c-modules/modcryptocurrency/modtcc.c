...
#define BIP32_CACHE_SIZE (0)
#define USE_BIP32_CACHE (0)
#define BIP32_CACHE_MAXDEPTH (0)
#define RAND_PLATFORM_INDEPENDENT   (1)
#define USE_BIP39_GENERATE (0)
...
MP_REGISTER_MODULE(MP_QSTR_trezorcrypto, mp_module_tcc, MODULE_TREZORCRYPTO_ENABLED);
